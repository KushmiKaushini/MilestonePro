...
Goal _goalDeserialize(
  ...
  final object = Goal();
  object.category =
      _GoalcategoryValueEnumMap[reader.readStringOrNull(offsets[0])] ??
...
P _goalDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_GoalcategoryValueEnumMap[reader.readStringOrNull(offset)] ??
          GoalCategory.fitness) as P;
    case 1:
...
const _GoalcategoryValueEnumMap = {
  r'fitness': GoalCategory.fitness,
  r'learning': GoalCategory.learning,
  r'finance': GoalCategory.finance,
  r'career': GoalCategory.career,
